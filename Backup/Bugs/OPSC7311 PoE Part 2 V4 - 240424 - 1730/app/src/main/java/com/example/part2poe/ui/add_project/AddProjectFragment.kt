...
class AddProjectFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        private fun addnewProject(
            ...
            val newProject = Project(projectName, minGoal,maxGoal,cost,calendar,category)
   ...
   /*fun populateSpinner(context: Context, spinner: Spinner) {
        ...
        private fun navigateToMainProject() {
            findNavController().navigate(MainCategoryFragmentDirections.actionAddprojectFragementToMainprojectFragement())
        }
